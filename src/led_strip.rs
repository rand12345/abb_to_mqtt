...
impl LedStrip<1> {
    pub fn set_color(
        ...
        match red {
            LedState::Off => self.buffer[0][1] = 0,
            LedState::On => self.buffer[0][1] = 0x10,
            LedState::NC => (),
        }
        match green {
            LedState::Off => self.buffer[0][0] = 0,
            LedState::On => self.buffer[0][0] = 0x10,
            LedState::NC => (),
        }
        match blue {
            LedState::Off => self.buffer[0][2] = 0,
            LedState::On => self.buffer[0][2] = 0x10,
            LedState::NC => (),
        }
